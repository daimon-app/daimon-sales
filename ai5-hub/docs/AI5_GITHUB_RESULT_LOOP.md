...
main merge、本番公開、販売開始、SNS公開、DM、課金、購入、契約、広告、OAuth、2FA、CAPTCHA、本人確認、不可逆操作、秘密情報外部送信は本人承認を維持する。実Task本文をPublic Repositoryへpushしない。private確認済みremoteだけ有効化し、secret検出時は拒否する。現在の`daimon-app/daimon-sales`はPublicのためruntime remote syncは無効。
