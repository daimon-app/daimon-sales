...
function Get-AI5CommandCenter {
  ...
  $bridge=Get-AI5CodexHealth;$claude=Get-AI5ClaudeHealth;$gemini=Get-AI5SpecialistHealth 'gemini';$manus=Get-AI5SpecialistHealth 'manus';$notebook=Get-AI5NotebookLMHealth
