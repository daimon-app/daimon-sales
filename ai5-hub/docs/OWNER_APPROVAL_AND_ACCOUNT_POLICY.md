...
通常main統合は、全回帰PASS、競合0、非force、Rollback READY、外部公開なし、金銭操作なし、秘密情報なし、重大な不可逆変更なしをすべて実証した場合に限りLEVEL 0とする。条件が欠ける場合はFail Closedし、mainという名称だけを自動承認またはOwner Gateの根拠にしない。
